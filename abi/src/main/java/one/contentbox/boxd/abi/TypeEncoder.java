...
import one.contentbox.boxd.abi.datatypes.BytesType;
...
import static one.contentbox.boxd.abi.datatypes.Type.MAX_BIT_LENGTH;
import static one.contentbox.boxd.abi.datatypes.Type.MAX_BYTE_LENGTH;
