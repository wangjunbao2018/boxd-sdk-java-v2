 ...
 */
public abstract class TypeReference<T extends one.contentbox.boxd.abi.datatypes.Type>
    ...
    public static <T extends one.contentbox.boxd.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends one.contentbox.boxd.abi.datatypes.Type>
